...
a20_ns_msg: db 'a20 int 0x15 :(', ENDL, 0
a20_no_status_msg: db 'a20 status :(', ENDL, 0
a20_failed_msg: db 'a20 could not activate :(', ENDL, 0
a20_active_msg: db 'a20 already active ?', ENDL, 0
a20_activated_msg: db 'a20 activated :)', ENDL, 0
